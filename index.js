...
function generaEmailHTML({ nome, passi, prodotti }) {
  ...
  const prodottiHTML = prodotti
    .map(
      (p) => `
      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom: 16px; border: 1.5px solid ${PINK_MID}; border-radius: 16px; overflow: hidden; background: white;">
        <tr>
          ...
          <td valign="middle" style="padding: 12px 12px 12px 0;">
            <p style="margin: 0 0 4px 0; font-family: sans-serif; font-size: 15px; font-weight: 700; color: ${TEXT_DARK};">${p.nome}</p>
            <p style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 13px; color: ${TEXT_SOFT}; line-height: 1.4;">${p.descrizione}</p>
            <a href="${p.link}" style="
...
<body style="margin: 0; padding: 0; background: #fff5f9;">
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #fff5f9; padding: 32px 16px;">
    <tr>
      <td align="center">
        <table cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px;">
          ...
          <tr>
            ...
            ">
              ...
              <h1 style="margin: 0; font-family: sans-serif; font-size: 26px; font-weight: 800; color: white; line-height: 1.2;">
          ...
          <!-- Intro -->
          <tr>
            <td style="background: white; padding: 28px 32px 8px 32px;">
              <p style="margin: 0; font-family: sans-serif; font-size: 16px; color: ${TEXT_MID}; line-height: 1.6;">
          ...
          <!-- Routine steps -->
          <tr>
            <td style="background: white; padding: 20px 32px 28px 32px;">
              <p style="margin: 0 0 16px 0; font-family: sans-serif; font-size: 12px; font-weight: 700; color: ${PINK}; text-transform: uppercase; letter-spacing: 0.08em;">
                La tua routine
              </p>
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ${passiHTML}
          ...
          <!-- Prodotti -->
          <tr>
            <td style="background: white; padding: 24px 32px 32px 32px; border-radius: 0 0 20px 20px;">
              <p style="margin: 0 0 16px 0; font-family: sans-serif; font-size: 12px; font-weight: 700; color: ${PINK}; text-transform: uppercase; letter-spacing: 0.08em;">
          ...
          <tr>
            <td style="padding: 24px 0 0 0; text-align: center;">
              <p style="margin: 0; font-family: sans-serif; font-size: 13px; color: ${TEXT_SOFT};">
